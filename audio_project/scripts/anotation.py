...
def generate_annotated_transcriptions(input_audio_path: str, book_path: str):
    ...
    chunk_directory = "data/chunks/mi_audio_importante"
...
if __name__ == "__main__":
    audio_file = "audio/mi_audio_importante.wav"  # Reemplaza con tu archivo de audio
    book_file = "book/mi_libro.txt"              # Reemplaza con tu archivo de libro
